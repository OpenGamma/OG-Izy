...
int main()
{       
        const char * countfilename = "count_expm1.txt";
        const char * inputfilename = "input_expm1.txt";        
        const char * expectedfilename = "expected_expm1.txt";        
        FILE * input = NULL;
        int i, ret;
