...
int main()
{       
        const char * countfilename = "count_tgamma.txt";
        const char * inputfilename = "input_tgamma.txt";        
        const char * expectedfilename = "expected_tgamma.txt";        
        FILE * input = NULL;
        int i, ret;
        ...
        /* make izy call */
        vd_tgamma(&count,in_data,&offsetin0,results_data,&offsetout0);
        ...
        /* make izy call */       
        vd_tgamma(&count_used,in_data,&offsetin_used0,results_data,&offsetout_used0);
        ...
        /* test NaN */
        IVAL = NAN;
        vd_tgamma(&one,&IVAL,&offsetin0,&RVAL,&offsetout0);
        if(!isnan(RVAL))
        {
                return _INCORRECTRESULT;
        }
