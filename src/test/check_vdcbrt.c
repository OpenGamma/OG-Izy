...
int main()
{       
        const char * countfilename = "count_cbrt.txt";
        const char * inputfilename = "input_cbrt.txt";        
        const char * expectedfilename = "expected_cbrt.txt";        
        FILE * input = NULL;
        int i, ret;
        ...
        /* make izy call */
        vd_cbrt(in_data,&offsetin0,results_data,&offsetout0,&count);
        ...
        /* make izy call */       
        vd_cbrt(in_data,&offsetin_used0,results_data,&offsetout_used0,&count_used);
        ...
        /* test NaN */
        IVAL = NAN;
        vd_cbrt(&IVAL,&offsetin0,&RVAL,&offsetout0,&one);
        if(!isnan(RVAL))
        {
                return _INCORRECTRESULT;
        }
