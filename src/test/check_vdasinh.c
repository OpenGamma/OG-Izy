...
int main()
{       
        const char * countfilename = "count_asinh.txt";
        const char * inputfilename = "input_asinh.txt";        
        const char * expectedfilename = "expected_asinh.txt";        
        FILE * input = NULL;
        int i, ret;
        ...
        /* make izy call */
        vd_asinh(in_data,&offsetin0,results_data,&offsetout0,&count);
        ...
        /* make izy call */       
        vd_asinh(in_data,&offsetin_used0,results_data,&offsetout_used0,&count_used);
        ...
        /* test NaN */
        IVAL = NAN;
        vd_asinh(&IVAL,&offsetin0,&RVAL,&offsetout0,&one);
        if(!isnan(RVAL))
        {
                return _INCORRECTRESULT;
        }
