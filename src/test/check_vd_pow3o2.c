...
#include "vd_pow3o2_c.inc"
  ...
  /* make izy call */
  vd_pow3o2(&count,in_data,&offsetin0,results_data,&offsetout0);
  ...
  /* make izy call */
  vd_pow3o2(&count_used,in_data,&offsetin_used0,results_data,&offsetout_used0);
  ...
  /* test NaN */
  IVAL = NAN;
  vd_pow3o2(&one,&IVAL,&offsetin0,&RVAL,&offsetout0);
