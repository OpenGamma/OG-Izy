...
int main()
{       
        const char * countfilename = "count_ceil.txt";
        const char * inputfilename = "input_ceil.txt";        
        const char * expectedfilename = "expected_ceil.txt";        
        FILE * input = NULL;
        int i, ret;
        ...
        /* make izy call */
        vd_ceil(in_data,&offsetin0,results_data,&offsetout0,&count);
        ...
        /* make izy call */       
        vd_ceil(in_data,&offsetin_used0,results_data,&offsetout_used0,&count_used);
        ...
        /* test NaN */
        IVAL = NAN;
        vd_ceil(&IVAL,&offsetin0,&RVAL,&offsetout0,&one);
        if(!isnan(RVAL))
        {
                return _INCORRECTRESULT;
        }
