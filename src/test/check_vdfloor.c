...
int main()
{       
        const char * countfilename = "count_floor.txt";
        const char * inputfilename = "input_floor.txt";        
        const char * expectedfilename = "expected_floor.txt";        
        FILE * input = NULL;
        int i, ret;
        ...
        /* make izy call */
        vd_floor(in_data,&offsetin0,results_data,&offsetout0,&count);
        ...
        /* make izy call */       
        vd_floor(in_data,&offsetin_used0,results_data,&offsetout_used0,&count_used);
        ...
        /* test NaN */
        IVAL = NAN;
        vd_floor(&IVAL,&offsetin0,&RVAL,&offsetout0,&one);
        if(!isnan(RVAL))
        {
                return _INCORRECTRESULT;
        }
