...
int main()
{       
        const char * countfilename = "count_acosh.txt";
        const char * inputfilename = "input_acosh.txt";        
        const char * expectedfilename = "expected_acosh.txt";        
        FILE * input = NULL;
        int i, ret;
        ...
        /* make izy call */
        vd_acosh(in_data,&offsetin0,results_data,&offsetout0,&count);
        ...
        /* make izy call */       
        vd_acosh(in_data,&offsetin_used0,results_data,&offsetout_used0,&count_used);
        ...
        /* test NaN */
        IVAL = NAN;
        vd_acosh(&IVAL,&offsetin0,&RVAL,&offsetout0,&one);
        if(!isnan(RVAL))
        {
                return _INCORRECTRESULT;
        }
