...
int main()
{       
        const char * countfilename = "count_cdfnorm.txt";
        const char * inputfilename = "input_cdfnorm.txt";        
        const char * expectedfilename = "expected_cdfnorm.txt";        
        FILE * input = NULL;
        int i, ret;
        ...
        /* make izy call */
        vd_cdfnorm(in_data,&offsetin0,results_data,&offsetout0,&count);
        ...
        /* make izy call */       
        vd_cdfnorm(in_data,&offsetin_used0,results_data,&offsetout_used0,&count_used);
        ...
        /* test NaN */
        IVAL = NAN;
        vd_cdfnorm(&IVAL,&offsetin0,&RVAL,&offsetout0,&one);
        if(!isnan(RVAL))
        {
                return _INCORRECTRESULT;
        }
