...
{       
        ...
        /* make izy call */
        vd_sub(&count,in_data0,&offsetin0,in_data1,&offsetin1,results_data,&offsetout0);
        ...
        /* make izy call */       
        vd_sub(&count_used,in_data0,&offsetin_used0,in_data1,&offsetin_used1,results_data,&offsetout_used0);
        ...
        IVAL0 = NAN;
        IVAL1 =  0.e0;                
        vd_sub(&one,&IVAL0,&offsetin0,&IVAL1,&offsetin1,&RVAL,&offsetout0);
        if(!isnan(RVAL))
        {
                return _INCORRECTRESULT;
        }
