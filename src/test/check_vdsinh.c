...
int main()
{       
        const char * countfilename = "count_sinh.txt";
        const char * inputfilename = "input_sinh.txt";        
        const char * expectedfilename = "expected_sinh.txt";        
        FILE * input = NULL;
        int i, ret;
        ...
        /* make izy call */
        vd_sinh(in_data,&offsetin0,results_data,&offsetout0,&count);
        ...
        /* make izy call */       
        vd_sinh(in_data,&offsetin_used0,results_data,&offsetout_used0,&count_used);
        ...
        /* test NaN */
        IVAL = NAN;
        vd_sinh(&IVAL,&offsetin0,&RVAL,&offsetout0,&one);
        if(!isnan(RVAL))
        {
                return _INCORRECTRESULT;
        }
