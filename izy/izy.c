...
#define IZY_ONEARGONERESULT(_T,_NAME,_IZYFNAME) \
v##_T##_reference_##_NAME(count, arg0, offsetarg0, out0, offsetout0);
#define IZY_D_ONEARGONERESULT(_NAME,_IZYFNAME) IZY_ONEARGONERESULT(d,_NAME,_IZYFNAME)
#define IZY_Z_ONEARGONERESULT(_NAME,_IZYFNAME) IZY_ONEARGONERESULT(z,_NAME,_IZYFNAME)
...
#define IZY_ONEARGTWORESULT(_T,_NAME,_IZYFNAME) \
v##_T##_reference_##_NAME(count, arg0, offsetarg0, out0, offsetout0, out1, offsetout1);
#define IZY_D_ONEARGTWORESULT(_NAME,_IZYFNAME) IZY_ONEARGTWORESULT(d,_NAME,_IZYFNAME)
#define IZY_Z_ONEARGTWORESULT(_NAME,_IZYFNAME) IZY_ONEARGTWORESULT(z,_NAME,_IZYFNAME)
...
#define IZY_TWOARGONERESULT(_T,_NAME,_IZYFNAME) \
v##_T##_reference_##_NAME(count, arg0, offsetarg0, arg1, offsetarg1, out0, offsetout0);
#define IZY_D_TWOARGONERESULT(_NAME,_IZYFNAME) IZY_TWOARGONERESULT(d,_NAME,_IZYFNAME)
#define IZY_Z_TWOARGONERESULT(_NAME,_IZYFNAME) IZY_TWOARGONERESULT(z,_NAME,_IZYFNAME)
