...
#include "vz_sub_c.inc"
  ...
  /* make izy call */
  vz_sub(&count,in_data0,&offsetin0,in_data1,&offsetin1,results_data,&offsetout0);
  ...
  /* make izy call */
  vz_sub(&count_used,in_data0,&offsetin_used0,in_data1,&offsetin_used1,results_data,&offsetout_used0);
